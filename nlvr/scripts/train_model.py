...
parser.add_argument('--feature_dim', default='9,14,14')
...
def train_loop(args):
    ...
    f_vocab = open('data/nlvr_vocab.pkl', 'rb')
    vocab, inv_vocab = pkl.load(f_vocab)
    args.vocab = vocab
    f_vocab.close()
    
    # load data
    train_image = h5py.File('../../../dataset/NLVR/h5/nlvr_train.h5', 'r')['image']
    train_sent_int = h5py.File('../../../dataset/NLVR/h5/nlvr_train.h5', 'r')['sent']
    train_labels = h5py.File('../../../dataset/NLVR/h5/nlvr_train.h5', 'r')['labels']
    
    dev_image = h5py.File('../../../dataset/NLVR/h5/nlvr_dev.h5', 'r')['image']
    dev_sent_int = h5py.File('../../../dataset/NLVR/h5/nlvr_dev.h5', 'r')['sent']
    dev_labels = h5py.File('../../../dataset/NLVR/h5/nlvr_dev.h5', 'r')['labels']
    
    test_image = h5py.File('../../../dataset/NLVR/h5/nlvr_test.h5', 'r')['image']
    test_sent_int = h5py.File('../../../dataset/NLVR/h5/nlvr_test.h5', 'r')['sent']
    test_labels = h5py.File('../../../dataset/NLVR/h5/nlvr_test.h5', 'r')['labels']
    ...
    'best_val_acc': -1, 'best_test_acc':-1, 'model_t_val': 0, 'model_t_test': 0
    }
